...
<head>
  ...
  <title>MaterialAdminLTE 2 | Editar Categorias</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      $queryCategorias=mysqli_query($db, "SELECT * FROM categorias WHERE Id_categoria = '".$_POST['id_categoria']."'") or die(mysqli_error());
    ...
    <div class="row">
      ...
      <div class="col-md-12">
          ...
          <form class="form-horizontal">
            <div class="box-body">
              <div class="form-group" id="form_codigo">
                <label for="id_categoria" class="col-sm-2 control-label">Codigo*</label>

                <div class="col-sm-9">
                  <input type="text" class="form-control" id="id_categoria" placeholder="Codigo" value="<?php echo $rowCategorias['Id_Categoria'];?>" disabled>
                </div>
              </div>
              <!-- Date -->
              <!-- 
              <div class="form-group" id="form_estado">
                <label for="id_categoria" class="col-sm-2 control-label">Estado*</label>

                <div class="col-sm-9">
                  <div class="radio">
                    <label>
                      <input type="radio" name="optionsRadios" id="estado" value="1" <?php //if($rowCategorias['Estado']==1){echo 'checked';} ?>>
                      Habilitado
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="optionsRadios" id="estado" value="0" <?php //if($rowCategorias['Estado']==0){echo 'checked';} ?>>
                      Desabilitado
                    </label>
                  </div>
                </div>
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Datos Categorias</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal">
            <div class="box-body">
              <div class="form-group" id="form_id_categoria">
                <label for="nombre" class="col-sm-2 control-label">Nombre Categoria*</label>

                <div class="col-sm-9">
                  <input type="text" class="form-control" id="nombre" placeholder="Ingrese ..." value="<?php echo $rowCategorias['Nombre'];?>">
                </div>
              </div>
              <div class="form-group" id="form_nombres">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="descripcion" placeholder="Ingrese ..." value="<?php echo $rowCategorias['Descripcion'];?>">
                </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $("#btnCancelar").click(function(){
      window.setTimeout('location.href="categorias.php"', 1);
    });
    ...
    $("#btnActualizar").click(function(){
      ...
      //   return false;
      // } else {
      //   $("#id_categoria").attr('required',false);
      //   $("#form_codigo").removeClass('has-success');
      //   $("#form_codigo").removeClass('has-error');
      ...
      // Variable con todos los valores necesarios para la consulta
		  var datos = 'id_categoria=' + Id_Categoria + '&nombre=' + Nombre + '&descripcion=' + Descripcion;

      // alert(datos);
      $.ajax({
        //Direccion destino
        url: "categorias_actualizar.php",
