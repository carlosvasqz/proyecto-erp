$(function(){
	...
	$("#txt_cliente").typeahead({  
		ajax: {
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=7',
			method: 'post',
			triggerLength: 1
		},
	...
	$("#txt_producto").typeahead({  
		ajax: {
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=2',
			method: 'post',
			triggerLength: 1
		},
	...
	$("#txt_codigo_producto").typeahead({  
		ajax: {
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=43',
			method: 'post',
			triggerLength: 1
		},
	...
	$("#txt_referencia_producto").typeahead({  
		ajax: {
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=51',
			method: 'post',
			triggerLength: 1
		},
	...
	$("#txt_vendedor").typeahead({  
		ajax: {
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=14',
			method: 'post',
			triggerLength: 1
		},
	...
	$(".add-carrito-venta").on("click", function(e) {
		...
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=8',
			type: 'post',
	...
	$(".delete-carrito-venta").on("click", function(e) {
		...
		var tipo_doc = $("#cbo-tipo-documento").val();
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=9',
			type: 'post',
			data: {'idproducto':id},
			dataType: 'json'
		}).done(function(data){
	...
	$(".txt-precio-producto").on("focusout", function(e) {
		...
		var tipo_doc = $("#cbo-tipo-documento").val();
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=10',
			type: 'post',
	...
	$(".btn-grabar-venta").on("click", function(e) {
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=11',
			type: 'post',
	...
	$(".btn-buscar-pedido-venta").on("click", function(e) {
		...
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=23',
			type: 'post',
	...
	$(".seleccionar-pedido-venta").on("click", function(e) {
		...
		var tipo_doc = $("#cbo-tipo-documento").val();
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=21',
			type: 'post',
			data: {'pedido_id':id},
			dataType: 'json'
		}).done(function(data){
	...
	$(".limpiar-pedido").on("click", function(e) {
		...
		$("#txt_vendedor").val('');
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=22',
			type: 'post',
			dataType: 'json'
		}).done(function(data){
			if(data.success==true){
	...
	$(".cbo-tipo-precio").on("change", function(e) {
		...
		var tipo_doc = $("#cbo-tipo-documento").val();
		$.ajax({
			url: ENV_WEBROOT+'Controller/ProductoController.php?page=39',
			type: 'post',
