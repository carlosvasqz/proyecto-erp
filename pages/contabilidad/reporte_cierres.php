  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cierres Diarios</li>
      </ol>
    </section>
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php 
                  ...
                  $queryCotizacionesNuevas=mysqli_query($db, "SELECT COUNT(*) AS Ordenes_Nuevas FROM cierres_diarios WHERE Fecha = '$fechaInicioAnioDB';") or die(mysqli_error());
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php 
                  $queryCotizacionesTotales=mysqli_query($db, "SELECT COUNT(*) AS Total_Cotizaciones FROM cierres_diarios") or die(mysqli_error());
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Reporte de Cierres</h3>
              <!-- tools box -->
              ...
              <table id="lista-ordenes" class="table table-bordered table-striped table-hover">
                <thead>
                  <tr>
                    ...
                    <th>Diferencia</th>
                    <th>Justificacion de Diferencia</th>
                  </tr>
                </thead>
                <tbody>
                 <?php
                    $queryOrdens=mysqli_query($db, "SELECT * FROM cierres_diarios") or die(mysqli_error());
                   while ($rowOrden=mysqli_fetch_array($queryOrdens)){
                      ...
                      echo '
                        <tr>
                            <td>'.$rowOrden['Id_Cierre_Diario'].'</td>
                           <td>'.fechaFormato(fechaIngAEsp($rowOrden['Fecha'])).'</td>
                            <td>'.$rowOrden['Hora'].'</td>
                            <td>'.$rowOrden['Id_Usuario'].'</td>
                            <td>'.$rowOrden['Ventas_Dia'].'</td>
                            <td>'.$rowOrden['Dinero_Caja'].'</td>
                            <td>'.$rowOrden['Diferencia'].'</td>
                            <td>'.$rowOrden['Justificacion_Diferencia'].'</td>
