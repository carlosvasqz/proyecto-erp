...
--
-- Servidor: localhost
-- Tiempo de generación: 11-06-2018 a las 06:29:41
...
--
-- Estructura de tabla para la tabla `cierres_anuales`
--

CREATE TABLE `cierres_anuales` (
  `Id_Cierre_Anual` varchar(20) NOT NULL,
  `Id_Usuario` varchar(10) NOT NULL,
  `Año` year(4) NOT NULL,
  `Fecha_Cierre` date NOT NULL,
  `Hora_Cierre` time NOT NULL,
  `Impuesto_Comercio` double(10,2) NOT NULL,
  `Total_Ventas` double(10,2) NOT NULL,
  `Total_Gastos` double(10,2) NOT NULL,
  `Total_Utilidad` double(10,2) NOT NULL,
  `Utilidad_Neta` double(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELACIONES PARA LA TABLA `cierres_anuales`:
--   `Id_Usuario`
--       `usuarios` -> `Id_Usuario`
--
...
CREATE TABLE `cierres_mensuales` (
  `Id_Cierre_Mensual` varchar(20) NOT NULL,
  `Id_Usuario` varchar(10) NOT NULL,
  `Fecha_Inicial` date NOT NULL,
  `Fecha_Final` date NOT NULL,
  `Fecha_Cierre` date NOT NULL,
  `Hora_Cierre` time NOT NULL,
  `Ventas_Mes` double(10,2) NOT NULL,
  `Total_Servicios_Publicos` double(10,2) NOT NULL,
  `Total_Planillas` double(10,2) NOT NULL,
  `Utilidad_Mes` double(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- RELACIONES PARA LA TABLA `conversiones`:
--   `Id_Articulo`
...
--
-- RELACIONES PARA LA TABLA `cotizaciones_compra`:
--
...
--
-- RELACIONES PARA LA TABLA `cotizaciones_venta`:
--   `Id_Cliente`
--       `clientes` -> `Id_Cliente`
--   `Id_Usuario`
--       `usuarios` -> `Id_Usuario`
...
--
-- RELACIONES PARA LA TABLA `detalles_cotizacion_compra`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Cotizacion`
--       `cotizaciones_compra` -> `Id_Cotizacion_Compra`
--
...
--
-- RELACIONES PARA LA TABLA `detalles_cotizacion_venta`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Cotizacion_Venta`
--       `cotizaciones_venta` -> `Id_Cotizacion_Venta`
--
...
--
-- RELACIONES PARA LA TABLA `detalles_factura_compra`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Factura`
--       `facturas_compra` -> `Id_Factura`
...
--
-- RELACIONES PARA LA TABLA `detalles_orden_compra`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Orden_Compra`
--       `ordenes_compra` -> `Id_Orden_Compra`
...
--
-- RELACIONES PARA LA TABLA `detalles_venta`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Venta`
--       `ventas` -> `Id_Venta`
...
--
-- RELACIONES PARA LA TABLA `detalles_venta_tmp`:
--   `Id_Articulo`
--       `articulos` -> `Id_Articulo`
--   `Id_Venta_Tmp`
--       `ventas_tmp` -> `Id_Venta_Tmp`
--
...
--
-- RELACIONES PARA LA TABLA `ventas_tmp`:
--   `Id_Cliente`
--       `clientes` -> `Id_Cliente`
--   `Id_Usuario`
--       `usuarios` -> `Id_Usuario`
...
--
-- Indices de la tabla `cierres_anuales`
--
ALTER TABLE `cierres_anuales`
  ADD PRIMARY KEY (`Id_Cierre_Anual`),
...
--
-- Filtros para la tabla `cierres_anuales`
--
ALTER TABLE `cierres_anuales`
  ADD CONSTRAINT `cierres_anuales_ibfk_1` FOREIGN KEY (`Id_Usuario`) REFERENCES `usuarios` (`Id_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `cierres_mensuales`
  ADD CONSTRAINT `cierres_mensuales_ibfk_1` FOREIGN KEY (`Id_Usuario`) REFERENCES `usuarios` (`Id_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`Id_Empleado`) REFERENCES `empleados` (`Codigo_Empleado`) ON DELETE CASCADE ON UPDATE CASCADE;
