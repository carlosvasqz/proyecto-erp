...
<head>
  ...
  <title>MaterialAdminLTE 2 | Panel Principal</title>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 nuevos miembros registrados hoy
                    </a>
                  </li>
                  <li>
                    <a href="#">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-red"></i> 5 nuevos miembros registrados hoy
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 ventas registradas
                    </a>
                  </li>
                  <li>
                    <a href="#">
